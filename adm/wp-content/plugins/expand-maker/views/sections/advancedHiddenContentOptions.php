	...
	<div class="panel-body">
		...
		<div class="yrm-sub-tab">
			...
			<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
					<?php echo $functions::createSelectBox($params['googleFonts'], 'hidden-content-font-family', esc_attr($dataObj->getOptionValue('hidden-content-font-family')));?><br>
				</div>
			</div>
			...
			<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
					<?php echo $functions::createSelectBox($params['hiddenContentAlign'], 'hidden-content-align', esc_attr($dataObj->getOptionValue('hidden-content-align')));?><br>
				</div>
			</div>
			<div class="row row-static-margin-bottom">
				<div class="col-xs-5">
				...
				<div class="col-xs-4">
					<?php echo $functions::createSelectBox($params['hiddenContentLineHeight'], 'yrm-hidden-content-line-height', esc_attr($dataObj->getOptionValue('yrm-hidden-content-line-height')));?><br>
				</div>
			</div>
			<div class="yrm-accordion-content yrm-hide-content">
				<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
					<div class="yrm-switch-wrapper">
						<label class="yrm-switch">
							<input type="checkbox" name="hidden-content-bg-image" id="hidden-content-bg-image" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('hidden-content-bg-image', true); ?>>
			...
			<div class="yrm-accordion-content yrm-hide-content">
				<div class="row form-group">
					...
					<div class="col-md-7 ycd-circles-width-wrapper">
						<?php echo $functions::yrmSelectBox($params['bgImageSize'], $dataObj->getOptionValue('hidden-content-bg-img-size'), array('name'=>"hidden-content-bg-img-size",'class' => 'yrm-js-select2'));?><br>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-md-5">
					...
					<div class="col-md-7 ycd-circles-width-wrapper">
						<?php echo $functions::yrmSelectBox($params['bgImageRepeat'], $dataObj->getOptionValue('hidden-content-bg-repeat'), array('name'=>"hidden-content-bg-repeat",'class' => 'yrm-js-select2'));?><br>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-md-5">
			...
			<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
					<div class="yrm-switch-wrapper">
						<label class="yrm-switch">
							<input type="checkbox" name="hidden-content-font-size-enable" id="hidden-content-font-size-enable" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('hidden-content-font-size-enable', true); ?>>
							<span class="yrm-slider yrm-round"></span>
						</label>
					</div>
				</div>
