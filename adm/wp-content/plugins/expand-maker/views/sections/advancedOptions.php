	...
	<div class="panel-body">
            ...
            <div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="load-data-after-action" id="load-data-after-action" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('load-data-after-action', true); ?>>
		...
		<?php if(!ReadMore::RemoveOption('button-border')): ?>
			<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
                    <div class="yrm-switch-wrapper">
                        <label class="yrm-switch">
                            <input type="checkbox" name="button-border" id="button-border" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('button-border', true); ?>>
                            <span class="yrm-slider yrm-round"></span>
                        </label>
                    </div>
				</div>
        ...
        <?php if(!ReadMore::RemoveOption('button-border-bottom')): ?>
			<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
                    <div class="yrm-switch-wrapper">
                        <label class="yrm-switch">
                            <input type="checkbox" name="yrm-button-border-bottom" id="yrm-button-border-bottom" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('yrm-button-border-bottom', true); ?>>
                            <span class="yrm-slider yrm-round"></span>
                        </label>
                    </div>
				</div>
			...
			<div class="yrm-accordion-content yrm-hide-content">
				...
				<div class="row row-static-margin-bottom">
					...
					<div class="col-xs-4">
						<?php echo $functions::createSelectBox($params['border-style'], 'yrm-button-bottom-border-style', esc_attr($savedObj->getOptionValue('yrm-button-bottom-border-style')));?><br>
					</div>
				</div>
				<div class="row row-static-margin-bottom">
					<div class="col-xs-5">
		...
		<?php if(!ReadMore::RemoveOption('button-box-shadow')): ?>
			<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
                    <div class="yrm-switch-wrapper">
                        <label class="yrm-switch">
                            <input type="checkbox" name="button-box-shadow" id="button-box-shadow" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('button-box-shadow', true); ?>>
                            <span class="yrm-slider yrm-round"></span>
                        </label>
                    </div>
				</div>
        ...
        <div class="row row-static-margin-bottom">
            ...
            <div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="enable-button-icon" id="enable-button-icon" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('enable-button-icon', true); ?>>
                        <span class="yrm-slider yrm-round"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="row row-static-margin-bottom">
            ...
            <div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="hover-effect" id="hover-effect" class="yrm-accordion-checkbox" <?php echo $hoverEffect; ?>>
                        <span class="yrm-slider yrm-round"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="row row-static-margin-bottom">
            ...
            <div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="auto-open" id="auto-open" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('auto-open', true); ?>>
                        <span class="yrm-slider yrm-round"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="row row-static-margin-bottom">
			...
			<div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="show-only-devices" id="show-only-devices" class="yrm-accordion-checkbox" <?php echo $showOnlyDevices; ?>>
                        <span class="yrm-slider yrm-round"></span>
                    </label>
                </div>
			</div>
		...
		<div class="yrm-accordion-content yrm-hide-content">
			...
			<div class="row row-static-margin-bottom">
				...
				<div class="col-xs-4">
                    <div class="yrm-switch-wrapper">
                        <label class="yrm-switch">
                            <input type="checkbox" name="hide-content" id="hide-content" class="yrm-accordion-checkbox" <?php echo $savedObj->getOptionValue('hide-content', true); ?>>
                            <span class="yrm-slider yrm-round"></span>
                        </label>
                    </div>
				</div>
		...
		<div class="row row-static-margin-bottom">
			...
			<div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="button-for-post" id="button-for-post" class="yrm-accordion-checkbox" <?php echo $buttonForPost; ?>>
                        <span class="yrm-slider yrm-round"></span>
                    </label>
                </div>
			</div>
