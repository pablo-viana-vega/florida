	...
	<div class="panel-body">
			...
			<div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="yrm-popup-esc-key" id="yrm-popup-esc-key" class="yrm-popup-esc-key" <?php echo $dataObj->getOptionValue('yrm-popup-esc-key', true); ?>>
		...
		<div class="row">
			...
			<div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="yrm-popup-close-button" id="yrm-popup-close-button" class="yrm-popup-close-button" <?php echo $dataObj->getOptionValue('yrm-popup-close-button', true); ?>>
                        <span class="yrm-slider yrm-round"></span>
                    </label>
                </div><br>
			</div>
		...
		<div class="row">
			...
			<div class="col-xs-4">
                <div class="yrm-switch-wrapper">
                    <label class="yrm-switch">
                        <input type="checkbox" name="yrm-popup-overlay-click" id="yrm-popup-overlay-click" class="yrm-popup-overlay-click" <?php echo $dataObj->getOptionValue('yrm-popup-overlay-click', true); ?>>
                        <span class="yrm-slider yrm-round"></span>
                    </label>
                </div><br>
			</div>
