...
final class MywpControllerModuleAdminPostEdit extends MywpControllerAbstractModule {
  ...
  public static function block_editor_top_left_icon() {
    ...
    echo '.edit-post-header .edit-post-fullscreen-mode-close.has-icon svg { display: none; }';
    echo '.edit-post-header .edit-post-fullscreen-mode-close.has-icon:before { font: normal 32px/1 dashicons; content: "\f341"; display: inline-block; }';
  ...
  public static function hide_publish_metabox_revisions() {
    ...
    echo '#misc-publishing-actions .misc-pub-section.misc-pub-revisions { display: none; }';
  ...
  public static function prevent_meta_boxes() {
    ...
    echo '$(".meta-box-sortables").sortable("destroy");';
