    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="mywp[data][include_css_file]" class="include_css_file large-text" value="<?php echo esc_attr( $setting_data['include_css_file'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com/admin.css or [mywp_theme field="url"]/admin.css' ); ?>" />
          </td>
        </tr>
        <tr>
          <th><?php _e( 'Include your JS file' , 'my-wp' ); ?></th>
          <td>
            <input type="text" name="mywp[data][include_js_file]" class="include_js_file large-text" value="<?php echo esc_attr( $setting_data['include_js_file'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com/admin.js or [mywp_theme field="url"]/admin.js' ); ?>" />
          </td>
        </tr>
        <tr>
          <th><?php _e( 'Input CSS' , 'my-wp' ); ?></th>
          <td>
            <textarea type="text" name="mywp[data][input_css]" class="input_css large-text" placeholder="<?php echo esc_attr( 'body.wp-admin{ background-color: #000;' ); ?>"><?php echo esc_attr( $setting_data['input_css'] ); ?></textarea>
          </td>
        </tr>
        <tr>
