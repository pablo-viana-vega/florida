    ...
    <table class="form-table">
      <tbody>
        <tr>
          ...
          <td>
            <input type="text" name="mywp[data][include_css_file]" class="include_css_file large-text" value="<?php echo esc_attr( $setting_data['include_css_file'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com/frontend.css or [mywp_theme field="url"]/frontend.css' ); ?>" />
          </td>
        </tr>
        <tr>
          <th><?php _e( 'Include your JS file' , 'my-wp' ); ?></th>
          <td>
            <input type="text" name="mywp[data][include_js_file]" class="include_js_file large-text" value="<?php echo esc_attr( $setting_data['include_js_file'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com/frontend.js or [mywp_theme field="url"]/frontend.js' ); ?>" />
          </td>
        </tr>
        <tr>
