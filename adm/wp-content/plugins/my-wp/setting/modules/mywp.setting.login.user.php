    ...
    <table class="form-table">
      <tbody>
        <tr>
          ...
          <td>
            <input type="text" name="mywp[data][login_redirect_url]" class="login_redirect_url large-text" value="<?php echo esc_attr( $setting_data['login_redirect_url'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com or [mywp_url admin="1"]' ); ?>" />
          </td>
        </tr>
        <tr>
          <th><?php _e( 'Logged out redirect URL' , 'my-wp' ); ?></th>
          <td>
            <input type="text" name="mywp[data][logout_redirect_url]" class="logout_redirect_url large-text" value="<?php echo esc_attr( $setting_data['logout_redirect_url'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com or [mywp_url login="1"]' ); ?>" />
          </td>
        </tr>
      </tbody>
    </table>
