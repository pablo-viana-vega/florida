    ...
    <table class="form-table">
      <tbody>
        <tr>
          ...
          <td>
            <input type="text" name="mywp[data][logo_link_url]" class="logo_link_url large-text" value="<?php echo esc_attr( $setting_data['logo_link_url'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com or [mywp_url]' ); ?>" />
          </td>
        </tr>
        <tr>
          <th><?php _e( 'Logo Image URL' , 'my-wp' ); ?></th>
          <td>
            <input type="text" name="mywp[data][logo_image_path]" class="logo_image_path large-text" value="<?php echo esc_attr( $setting_data['logo_image_path'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com/logo.png or [mywp_theme field="url"]/logo.png' ); ?>" />
          </td>
        </tr>
        <tr>
          <th><?php _e( 'Title' ); ?></th>
          <td>
            <input type="text" name="mywp[data][logo_title]" class="logo_title large-text" value="<?php echo esc_attr( $setting_data['logo_title'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) Example site title or [mywp_site field="name"]' ); ?>" />
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="mywp[data][include_css_file]" class="include_css_file large-text" value="<?php echo esc_attr( $setting_data['include_css_file'] ); ?>" placeholder="<?php echo esc_attr( 'e.g.) https://example.com/login.js or [mywp_theme field="url"]/login.css' ); ?>" />
          </td>
        </tr>
        <tr>
